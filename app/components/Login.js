    ...
    <div className="flex items-center justify-center min-h-screen bg-primary">
      <div className="w-full max-w-md p-8 space-y-6 bg-secondary rounded-lg shadow-lg">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-700 px-4 py-3 rounded-md font-semibold hover:bg-gray-50 transition-all disabled:opacity-50 border-2 border-gray-300"
        >
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-secondary text-light-gray">Or continue with email</span>
          </div>
        </div>
